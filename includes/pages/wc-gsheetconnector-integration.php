...
<div class="card-wp">
  <div class="gs-woo-in-fields">
    <h2> <span class="title1"><?php echo __('WooCommerce - '); ?></span> <span class="title"><?php echo __('Google Sheets Integration'); ?></span> </h2>
    <hr>
    <?php if (empty($Code)) { ?>
    <div class="wpform-gs-alert-kk" id="google-drive-msg">
      <p class="wpform-gs-alert-heading"> <?php echo esc_html__('Authenticate with your Google account, follow these steps:', 'wc-gsheetconnector'); ?> </p>
      <ol class="wpform-gs-alert-steps">
        ...
        <li><?php echo esc_html__('Grant permissions for the following:', 'wc-gsheetconnector'); ?>
          <ul class="wpform-gs-alert-permissions">
            ...
            <li><?php echo esc_html__('Google Sheets', 'wc-gsheetconnector'); ?> <span class="wpform-gs-alert-note"> <?php echo esc_html__('Ensure that you enable the checkbox for each of these services.', 'wc-gsheetconnector'); ?> </span></li>
          </ul>
        </li>
    ...
    <p>
      ...
      <span class="tooltip"> <img src="<?php echo WC_GSHEETCONNECTOR_URL; ?>assets/img/help.png" class="help-icon"> <span class="tooltiptext tooltip-right">
    ...
    <p class="gs-woo-sync-row"> <?php echo __('<a id="gs-woo-sync" data-init="yes">Click here </a> to fetch sheets detail for "WooCommerce Data Settings" tab.', 'wc-gsheetconnector'); ?> <span class="loading-sign">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> </p>
    <?php } 
       ?>
    <p>
      <label><?php echo __('Debug Log', 'wc-gsheetconnector'); ?></label>
      <button class="wcgsc-logs"><?php echo __('View', 'wc-gsheetconnector'); ?></button>
    ...
    <div id="wc-gsc-cta" class="wc-gsc-privacy-box">
      <div class="wc-gsc-table">
        <div class="wc-gsc-less-free"> <i class="dashicons dashicons-lock"></i>
          <p> <?php echo __('We do not store any of the data from your Google account on our servers, everything is processed & stored on your server. We take your privacy extremely seriously and ensure it is never misused.', 'wc-gsheetconnector'); ?><br />
            <a href="https://gsheetconnector.com/usage-tracking/" target="_blank"><?php echo __('Learn more.', 'wc-gsheetconnector'); ?></a></p>
        </div>
      </div>
    </div>
  </div>
...
<div class="two-col wc-free-box-help12">
  <div class="col wc-free-box12">
    <header>
      <h3><?php echo __('Next steps…', 'wc-gsheetconnector'); ?></h3>
    </header>
    <div class="wc-free-box-content12">
      <ul class="wc-free-list-icon12">
        <li> <a href="https://www.gsheetconnector.com/woocommerce-google-sheet-connector-pro"
                        target="_blank">
          <div>
            <button class="icon-button"> <span class="dashicons dashicons-star-filled"></span> </button>
            <strong><?php echo __('Upgrade to PRO', 'wc-gsheetconnector'); ?></strong>
            <p><?php echo __('Sync Orders, Order wise data and much more...', 'wc-gsheetconnector'); ?></p>
          </div>
          </a> </li>
        <li> <a href="https://www.gsheetconnector.com/docs/woocommerce-google-sheet-connector-pro/requirements"
                        target="_blank">
          <div>
            <button class="icon-button"> <span class="dashicons dashicons-download"></span> </button>
            <strong><?php echo __('Compatibility', 'wc-gsheetconnector'); ?></strong>
            <p><?php echo __('Compatibility with WooCommerce Third-Party Plugins', 'wc-gsheetconnector'); ?></p>
          </div>
          </a> </li>
        <li> <a href="https://www.gsheetconnector.com/docs/woocommerce-google-sheet-connector-pro"
                        target="_blank">
          <div>
            <button class="icon-button"> <span class="dashicons dashicons-chart-bar"></span> </button>
            <strong><?php echo __('Multi Languages', 'wc-gsheetconnector'); ?></strong>
            <p><?php echo __('This plugin supports multi-languages as well!', 'wc-gsheetconnector'); ?></p>
          </div>
          </a> </li>
        <li> <a href="https://www.gsheetconnector.com/docs/woocommerce-google-sheet-connector-pro"
                        target="_blank">
          <div>
            <button class="icon-button"> <span class="dashicons dashicons-download"></span> </button>
            <strong><?php echo __('Support Wordpress multisites', 'wc-gsheetconnector'); ?></strong>
            <p><?php echo __('With the use of a Multisite, you’ll also have a new level of user-available: the Super
              Admin.', 'wc-gsheetconnector'); ?></p>
          </div>
          </a> </li>
      </ul>
    </div>
  ...
  <div class="col wc-free-box13">
    <header>
      <h3><?php echo __('Product Support', 'wc-gsheetconnector'); ?></h3>
    </header>
    <div class="wc-free-box-content13">
      <ul class="wc-free-list-icon13">
        <li> <a href="https://www.gsheetconnector.com/docs/woocommerce-google-sheet-connector-pro"
                        target="_blank"> <span class="dashicons dashicons-book"></span>
          <div> <strong><?php echo __('Online Documentation', 'wc-gsheetconnector'); ?></strong>
            <p><?php echo __('Understand all the capabilities of Woocommerce GsheetConnector', 'wc-gsheetconnector'); ?></p>
          </div>
          </a> </li>
        <li> <a href="https://www.gsheetconnector.com/docs/woocommerce-google-sheet-connector-pro"
                        target="_blank"> <span class="dashicons dashicons-sos"></span>
          <div> <strong><?php echo __('Ticket Support', 'wc-gsheetconnector'); ?></strong>
            <p><?php echo __('Direct help from our qualified support team', 'wc-gsheetconnector'); ?></p>
          </div>
          </a> </li>
        <li> <a href="https://www.gsheetconnector.com/affiliates"
                        target="_blank"> <span class="dashicons dashicons-admin-links"></span>
          <div> <strong><?php echo __('Affiliate Program', 'wc-gsheetconnector'); ?></strong>
            <p><?php echo __('Earn flat 30% on every sale!', 'wc-gsheetconnector'); ?></p>
          </div>
          </a> </li>
      </ul>
    </div>
